...
// ThIS IS FOR filtering information (CREATING FILTERS)
...
function filterCategory(filterBy, buttonClicked){
  ...
  for(let listItem of itemsToFilter){
    ...
    // we're setting its display to block, otherwise if it doesn't have the class we're looking for we're going to hide it by setting the display to none
